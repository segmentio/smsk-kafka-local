...
docker rm zookeeper kafka-1 kafka-2 kafka-3 kafka-4 
docker rm jmx_exporter kafka_exporter prometheus grafana lag_exporter
docker rm cmak cruise-control cruise-control-ui
docker rm producer-1 consumer-1
docker rm smsk-bulrush-test
